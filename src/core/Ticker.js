...
class Ticker {
	 ...
	 * @param {boolean} [pauseOnFreeze=true] - If the ticker should pause when the game freezes. Helps prevent jumping when user tabs out and back in.
	 * @param {number} [freezeThreshold=0.3] - The threshold before the game pauses **between 0 and 1**. Higher values means the fps doesn't have to dip as low for the ticker to pause.
	 */
